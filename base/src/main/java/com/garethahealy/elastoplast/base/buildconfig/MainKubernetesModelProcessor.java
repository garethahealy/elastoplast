...
public class MainKubernetesModelProcessor {
    ...
    public void withTemplateBuilder(TemplateBuilder builder) {
        ...
        builder.removeFromDeploymentConfigObjects(getDeploymentConfig(null, builder));
    }

    private DeploymentConfig getDeploymentConfig(Object ignore, TemplateBuilder builder) {
        DeploymentConfig answer = null;
        for (HasMetadata hasMetadata : builder.getObjects()) {
            if (hasMetadata instanceof DeploymentConfig) {
                answer = (DeploymentConfig)hasMetadata;
                break;
            }
        }
